...
export default class SalzmagazinStation1FrageScreen extends React.Component {
  ...
  static navigationOptions = {
    title: 'Salzmagazin Station 1 Frage',
  };
  state = {
  ...
  render() {
    return (      
      <View style={styles.wholeScreen}>
        ...
        <Button title='A   Stanserhornbahn' color="#fff" />
        </View>

        <View style = {styles.answerButton}>
        <Button title='B   Winkelriedhaus' color="#fff" />
        </View>

        <View style = {styles.answerButton}>
        <Button title='C   Kollegium Stans' color="#fff" />
        </View>

        <View style = {styles.lastAnswerButton}>
        <Button title='D   Frauenkloster Stans' color="#fff" />
        </View>
